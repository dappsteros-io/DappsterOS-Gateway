...
func TestRoutesPersistence(t *testing.T) {
	tmpdir1, _ := os.MkdirTemp("", "DappsterOS-Gateway-route-test")
	tmpdir2, _ := os.MkdirTemp("", "DappsterOS-Gateway-route-test")
...
func TestPathSorting(t *testing.T) {
	tmpdir, _ := os.MkdirTemp("", "DappsterOS-Gateway-route-test")
